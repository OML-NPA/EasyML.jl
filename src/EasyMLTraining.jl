...
export load_options, modify, save_model, load_model, set_problem_type, set_training_input_data, set_training_label_data, remove_training_data, remove_testing_data, 
    remove_training_results, train, forward, apply_border_data
